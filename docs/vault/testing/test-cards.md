...
| **CM-T07** | Integration — import pipeline: staged vanilla .dat → parser → SQLite-WASM (CM-011/012 schema): 10,580 clubs, Arsenal id 676, name-index integrity, attribute ranges | Pi | suite green against real fixture set |
