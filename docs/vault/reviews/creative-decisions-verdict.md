...
| H12 SQL DDL migration runner vs TS object migrations | **ACCEPTED** | Real incoherence: SQLite save state needs schema_version table + ordered .sql patches. Folds into CM-R10 plan v3 (and CM-020 spec). |
