...
| **CM-T08B** | Real OPFS save/load + locking in a browser context | Pi | CM-020 |
...
| **CM-T14** | OPFS edge-case suite: quota exhaustion, private-mode fallback, corrupt saves — specified once the CM-011/012 storage design lands; PLUS canonical synthetic .dat generator for PRs + encrypted CI fixture vault | Pi | None |
